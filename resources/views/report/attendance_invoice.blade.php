...
<div class="invoice-area">
    <div class="invoice-wrapper">
        <div class="invoice-header">
            <div class="invoice-flex-contents">
                <div class="invoice-logo">
                    <img src="{{ public_path('img/retinasoft.jpeg') }}" width="100px" height="100px" alt="">
                </div>
                <div class="invoice-header-contents" style="float:right;margin-top:-120px;">
                    <h4 class="invoice-title">{{ __('ATTENDANCE') }}</h4>
                </div>
            </div>
        </div>
            ...
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    ...
                    <ul class="details-list">
                        ...
                        <li class="list"> <strong>{{ __('Phone') }}: </strong> {{ __('01877-756677') }} </li>
                        <li class="list"> <strong>{{ __('Address') }}: </strong>{{ __('House#1, Road#2, Metro-housing, 1207')  }} </li>
                    </ul>
                </div>
                <div class="invoice-single-details" style="float:left;margin-top:-120px;">
        ...
        <div class="item-description">
            <h5 class="table-title">{{ __('Attendance') }}</h5>
            <table class="custom--table">
                ...
                <tbody>
                    ...
                    @empty
                    <td colspan="6">No Attendance Availabe</td>
